...
- `Size`
- `FootPositionAdjust`
- guided-request defaults such as `GuidedPathMode`, `GuidedAllowUnwalkableEndNode`, `GuidedAllowTraversalTransitions`, and the built-in chart request tuning values
- `GlobalId`
- `OccupantGroupId`
- `IsLockedOn`
- `AnimDampTime`
