...
public sealed class NavigationVolumeTransitionDeterminismMatrixTests
{
    ...
    public NavigationVolumeTransitionDeterminismMatrixTests(ITestOutputHelper output) =>
        _output = output;
        ...
        string expectedDigest)
    {
        ...
        _output.WriteLine($"NAVIGATION_VOLUME_CANONICAL={caseName}|{canonical}");
        _output.WriteLine($"NAVIGATION_VOLUME_DIGEST={digest} CASE={caseName}");
    ...
    private static string BuildCanonical(string caseName) => caseName switch
    {
        ...
        _ => throw new InvalidOperationException(
            $"Unknown navigation-volume digest case '{caseName}'.")
    };
