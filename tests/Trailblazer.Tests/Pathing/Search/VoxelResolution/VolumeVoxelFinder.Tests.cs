...
public sealed class VolumeVoxelFinderTests : IDisposable
{
    ...
    public void VolumeRequestFactories_ShouldFailForInvalidEndpoints_WhenAllowUnwalkableIsFalse()
    {
        ...
        VolumeVoxelFinder.TryGetPathEdgeVoxels(TestWorld.Context, new Vector3d(-1, 0, 0),
            new Vector3d(2, 0, 0),
            out _,
            out _,
            Fixed64.One,
        ...
        VolumePathRequest.Create(TestWorld.Context, new Vector3d(-1, 0, 0),
            new Vector3d(2, 0, 0),
            Fixed64.One,
            allowUnwalkableEndpoints: false,
    ...
    public void VolumeRequest_ShouldResolveInvalidEndpointsConsistently_AcrossCreateUpdateAndSetters()
    {
        ...
        VolumePathRequest created = TestRequire.NotNull(VolumePathRequest.Create(TestWorld.Context, new Vector3d(-1, 0, 0),
            new Vector3d(2, 0, 0),
            Fixed64.One,
            allowUnwalkableEndpoints: true,
        ...
        VolumePathRequest updated = TestRequire.NotNull(VolumePathRequest.Create(TestWorld.Context, Vector3d.Zero,
            new Vector3d(1, 0, 0),
            Fixed64.One,
            allowUnwalkableEndpoints: true,
            medium: TraversalMedium.Gas));
        ...
        VolumePathRequest setters = TestRequire.NotNull(VolumePathRequest.Create(TestWorld.Context, Vector3d.Zero,
            new Vector3d(1, 0, 0),
            Fixed64.One,
            allowUnwalkableEndpoints: true,
            medium: TraversalMedium.Gas));
    ...
    public void VolumeSnapping_ShouldHonorHostExtendedSolidBackedEndpoints()
    {
        ...
        PathTestFactory.RegisterSingleWalkablePoint(TestWorld.Context, "HostExtendedStart", Vector3d.Zero);
        PathTestFactory.RegisterSingleWalkablePoint(TestWorld.Context, "HostExtendedEnd", new Vector3d(1, 0, 0));
        ...
        VolumePathRequest request = TestRequire.NotNull(VolumePathRequest.Create(TestWorld.Context, new Vector3d(-1, 0, 0),
            new Vector3d(2, 0, 0),
            Fixed64.One,
            allowUnwalkableEndpoints: true,
            medium: TraversalMedium.Gas));
    ...
    public void VolumeRequest_ShouldAllowSizeFallback_WhenExactEndpointOnlyFailsClearance()
    {
        ...
        Voxel edgeVoxel = TestRequire.VoxelAt(TestWorld.Context, new Vector3d(0, 2, 2));
        Voxel interiorVoxel = TestRequire.VoxelAt(TestWorld.Context, new Vector3d(1, 2, 2));

        VolumeVoxelFinder.IsTraversable(TestWorld.Context, edgeVoxel, Fixed64.Two, TraversalMedium.Gas).Should().BeFalse();
        VolumeVoxelFinder.IsTraversable(TestWorld.Context, interiorVoxel, Fixed64.Two, TraversalMedium.Gas).Should().BeTrue();

        VolumeVoxelFinder.GetStartVoxel(TestWorld.Context, new Vector3d(0, 2, 2),
            new Vector3d(4, 2, 2),
            out Voxel? startVoxel,
            allowUnwalkableEndpoints: false,
        ...
        VolumePathRequest request = TestRequire.NotNull(VolumePathRequest.Create(TestWorld.Context, new Vector3d(0, 2, 2),
            new Vector3d(4, 2, 2),
            Fixed64.Two,
            allowUnwalkableEndpoints: false,
            medium: TraversalMedium.Gas));
    ...
    public void VolumeRequest_ShouldAllowSizeFallback_WhenSolidBackedEndpointOnlyFailsClearance()
    {
        ...
        PathTestFactory.RegisterFromData(TestWorld.Context, "SolidGasFallback", data, Vector3d.Zero);

        VolumeMediumRules.SetGasVoxelRule(static voxel => voxel != null && voxel.HasPartition<SolidChartPartition>());

        Voxel edgeVoxel = TestRequire.VoxelAt(TestWorld.Context, new Vector3d(0, 0, 1));
        Voxel interiorVoxel = TestRequire.VoxelAt(TestWorld.Context, new Vector3d(1, 0, 1));

        VolumeVoxelFinder.IsTraversable(TestWorld.Context, edgeVoxel, Fixed64.Two, TraversalMedium.Gas).Should().BeFalse();
        VolumeVoxelFinder.IsTraversable(TestWorld.Context, interiorVoxel, Fixed64.Two, TraversalMedium.Gas).Should().BeTrue();

        VolumeVoxelFinder.GetStartVoxel(TestWorld.Context, new Vector3d(0, 0, 1),
            new Vector3d(4, 0, 1),
            out Voxel? startVoxel,
            allowUnwalkableEndpoints: false,
            unitSize: Fixed64.Two,
    ...
    public void IsDirectPathClear_ShouldReturnFalse_WhenMediumIsNotConfigured()
    {
        ...
        VolumeVoxelFinder.IsDirectPathClear(TestWorld.Context, Vector3d.Zero,
            new Vector3d(1, 0, 0),
            Fixed64.One,
            allowUnwalkableEndpoints: false,
            medium: TraversalMedium.Gas).Should().BeFalse();
    ...
    public void IsDirectPathClear_ShouldReturnTrue_WhenGasCorridorIsUnobstructed()
    {
        ...
        Voxel endVoxel = TestRequire.VoxelAt(TestWorld.Context, new Vector3d(2, 0, 0));
    ...
    public void IsDirectPathClear_ShouldReturnFalse_WhenBlockerIsInPath()
    {
        ...
        PathTestFactory.RegisterGeneratedVolumePoint(TestWorld.Context, Vector3d.Zero, TraversalMedium.Gas, "GasGap");
        PathTestFactory.RegisterGeneratedVolumePoint(TestWorld.Context, new Vector3d(2, 0, 0), TraversalMedium.Gas, "GasGap");
    ...
    public void IsDirectPathClear_ShouldReturnFalse_WhenRelaxedEndpointFailsMediumCheck()
    {
        ...
        PathTestFactory.RegisterSingleWalkablePoint(TestWorld.Context, "RelaxedSolidStart", Vector3d.Zero);
        RegisterGasLine(new Vector3d(1, 0, 0), 2, "RelaxedGasRest");

        Voxel solidStart = TestRequire.VoxelAt(TestWorld.Context, Vector3d.Zero);
        Voxel gasEnd = TestRequire.VoxelAt(TestWorld.Context, new Vector3d(2, 0, 0));
    ...
    public void IsDirectPathClear_ShouldAllowRelaxedEndNode_WhenOnlyEndNodeMatches()
    {
        ...
        Voxel interiorStart = TestRequire.VoxelAt(TestWorld.Context, new Vector3d(1, 2, 2));
        Voxel edgeEnd = TestRequire.VoxelAt(TestWorld.Context, new Vector3d(0, 2, 2));

        VolumeVoxelFinder.IsTraversable(TestWorld.Context, interiorStart, Fixed64.Two, TraversalMedium.Gas).Should().BeTrue();
        VolumeVoxelFinder.IsTraversable(TestWorld.Context, edgeEnd, Fixed64.Two, TraversalMedium.Gas).Should().BeFalse();

        VolumeVoxelFinder.IsDirectPathClear(TestWorld.Context, new Vector3d(1, 2, 2),
            new Vector3d(0, 2, 2),
            Fixed64.Two,
            allowUnwalkableEndpoints: true,
            medium: TraversalMedium.Gas,
    ...
    public void IsTraversable_ShouldReturnFalse_WhenVoxelHasNoTrailblazerPartition()
    {
        ...
        PathTestFactory.RegisterGeneratedVolumePoint(TestWorld.Context, new Vector3d(3, 0, 0), TraversalMedium.Gas, "GasElsewhere");

        // Get a plain grid voxel that has no chart partition at all.
        Voxel plainVoxel = TestRequire.VoxelAt(TestWorld.Context, Vector3d.Zero);

        // IsBaseTraversable → no VolumeChartPartition and no SolidChartPartition → return false.
        VolumeVoxelFinder.IsTraversable(TestWorld.Context, plainVoxel, Fixed64.One, TraversalMedium.Gas).Should().BeFalse();
    }

    private static void ConfigureGrid(Vector3d minBounds, Vector3d maxBounds)
    {
        TestWorld.World.TryAddGrid(new GridConfiguration(minBounds, maxBounds), out _);
    }

    /// <summary>
    /// Covers the null-coalescing branch <c>unitSize ?? TestWorld.Context.VoxelSize</c> in
    ...
    public void GetStartVoxel_ShouldUseGlobalVoxelSize_WhenUnitSizeIsOmitted()
    {
        ...
        bool resolved = VolumeVoxelFinder.GetStartVoxel(TestWorld.Context, Vector3d.Zero,
            new Vector3d(1, 0, 0),
            out Voxel? startVoxel);
    ...
    public void GetEndVoxel_ShouldUseGlobalVoxelSize_WhenUnitSizeIsOmitted()
    {
        ...
        // No unitSize argument → parameter defaults to null → covers the ?? VoxelSize branch.
        bool resolved = VolumeVoxelFinder.GetEndVoxel(TestWorld.Context, Vector3d.Zero,
            new Vector3d(1, 0, 0),
            out Voxel? endVoxel);
    ...
    {
        ConfigureGrid(new Vector3d(-4, -4, -4), new Vector3d(8, 8, 8));
        PathTestFactory.RegisterGeneratedVolumePoint(TestWorld.Context, new Vector3d(2, 0, 1), TraversalMedium.Gas, "GasClosestPerpendicular");
        PathTestFactory.RegisterGeneratedVolumePoint(TestWorld.Context, new Vector3d(2, 0, 2), TraversalMedium.Gas, "GasClosestPerpendicular");

        Voxel center = TestRequire.VoxelAt(TestWorld.Context, new Vector3d(1, 0, 1));

        VolumeVoxelFinder.TryGetClosestTraversableVoxel(TestWorld.Context, center,
    ...
    {
        ConfigureGrid(new Vector3d(-4, -4, -4), new Vector3d(8, 8, 8));
        PathTestFactory.RegisterGeneratedVolumePoint(TestWorld.Context, new Vector3d(2, 0, 2), TraversalMedium.Gas, "GasClosestDiagonal");
