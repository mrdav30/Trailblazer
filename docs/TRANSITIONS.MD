...
- `PathManager.UnloadChart(...)` does not automatically unregister transitions that were already registered, including generated transitions from `TraversalBuildResult`
