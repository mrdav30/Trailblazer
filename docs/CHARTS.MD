...
When you need mixed traversal media or authored per-cell metadata instead of one uniform medium, use the `NavigationChartCell[,,]` overload of `NavigationChart.From3D(...)`.
