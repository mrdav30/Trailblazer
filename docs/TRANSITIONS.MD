...
- external `GlobalGridManager.TryAddGrid(...)` and `TryRemoveGrid(...)` rebuild live pathing state
  from the registered initialized charts and then reevaluate managed transitions
