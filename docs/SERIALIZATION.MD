...
- `src/Trailblazer/Main/Navigator.cs`
...
- `Size`
- `FootPositionAdjust`
- guided-request defaults such as `GuidedPathMode`, `GuidedAllowUnwalkableEndpoints`, `GuidedAllowTraversalTransitions`, and the built-in chart request tuning values
- `GlobalId`
- `OccupantGroupId`
- `IsLockedOn`
- `AnimDampTime`
