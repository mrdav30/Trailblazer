...
namespace Trailblazer.Tests.Navigation.Motor
{
    ...
    public class PlatformLocomotionTests
	{
		...
		public void Given_ScoutJumpsBeforePlatformMoves_When_Simulated_Then_ShouldNotInheritFutureVelocity()
		{
			...
			TrailblazerManager.Simulate();
			scout.SetTravelRequest(direction: Vector3d.Zero, rate: TrekRate.Stationary, isRequestingJump: true);
			scout.Simulate();
			scout.Visualize();
			...
			scout.Motor.Locomotions.Move.Velocity.x.Should().Be(Fixed64.Zero);
		}
        ...
        public void Given_ScoutWithInitTransfer_When_Jumping_Then_ShouldInheritPlatformVelocity()
        {
            ...
            scout.Motor.Locomotions.Move.Velocity.x.Should().BeGreaterThan(Fixed64.Zero);
        }
        ...
        public void Given_ScoutOnPlatform_When_JumpsWithInitTransfer_Then_InertiaShouldNotDoubleApply()
        {
            ...
            Vector3d velocityAfterJump = scout.Motor.Locomotions.Move.Velocity;
        ...
        public void Given_JumpingScout_When_PlatformIsMoving_Then_ShouldInheritVelocity()
        {
            ...
            // Assert
            scout.Motor.Locomotions.Move.Velocity.Should().NotBe(Vector3d.Zero);
            scout.Motor.Locomotions.Move.Velocity.x.Should().Be(scout.Motor.Locomotions.Platform.PlatformVelocity.x);
        }
        ...
        public void Given_ScoutUsesPlatformInertia_When_Lands_Then_FrameVelocityShouldBeCleared()
        {
            ...
            scout.Visualize(); // Would trigger inertia clearing
